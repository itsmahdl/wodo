...
class FourafterTomorrow extends StatefulWidget {
  @override
  _TestState createState() => _TestState();
}

class _TestState extends State<FourafterTomorrow> {
  DatabaseHelper dbHelper = DatabaseHelper();
  var format = DateFormat.yMMMd().format(DateTime.now().add(Duration(days: 5)));
  @override
                      ...
                      builder: (context, snapshot) {
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final tomorrow = DateTime.now().add(Duration(days: 5));
